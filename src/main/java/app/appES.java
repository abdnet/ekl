...
import imnet.sid.fulltext.dao.DAO;
import imnet.sid.fulltext.dao.DocumentDao;
...
public class appES {
	...
	public static void main(String[] args) throws Exception {
		...
		HashMap<String, Object> filter_1_proprety = new HashMap<String, Object>() {{
				...
				HashMap<String, Object> filter_elision = new HashMap<String, Object>() {{
					   put("type","elision");
					   put("articles", new String[]{"l", "m", "t", "qu", "n", "s", "j", "d", "c", "jusqu", "quoiqu", "lorsqu", "puisqu"});
						
							}};	
				HashMap<String, Object> filter_synonym = new HashMap<String, Object>() {{
					put("type","synonym");
					put("synonyms_path", "synonyms/syno_french.txt");
									
										}};
								
				HashMap<String, Object> french_stemmer = new HashMap<String, Object>() {{
					put("type","stemmer");
					put("language", "french");
		...
		ImnetFilter f1 = new  FilterBuilder()
				...
				.build();
		ImnetFilter f3 = new  FilterBuilder()
				.isDefault()
				.setFilter_object(filters_lot_2)
				.build();
		...
		HashMap<String, Object> analyze_3_proprety = new HashMap<String, Object>() {{
		    put("type","custom");
		    put("tokenizer","standard");
		    put("filter",f3);
		}};
